DROP DATABASE IF EXISTS ChinookDataWarehouse
...
CREATE TABLE DimCustomer(
	...
	Company nvarchar(80) DEFAULT 'N/A' NULL,
	FirstName nvarchar(40) NOT NULL,
	LastName nvarchar(20) NOT NULL,
	Address nvarchar(70) NULL,
	City nvarchar(40) NULL,
	State nvarchar(40) DEFAULT 'N/A' NULL,
	PostalCode nvarchar(10) DEFAULT 'N/A' NULL,
...
-- DimTracks dimension will need to include:
CREATE TABLE DimTrack(
	...
	Composer nvarchar(220) DEFAULT 'N/A' NULL,
	UnitPrice numeric(10, 2) NULL
);

-- FactInvoice will need to include:
...
DECLARE @EndDate DATETIME = '2024-12-31' --End Value of Date Range
